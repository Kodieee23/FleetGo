...
<div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700 mb-8">
    <form method="GET" action="{{ route('admin.trips') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="flex items-end space-x-2">
            ...
            <a href="{{ route('admin.trips') }}" class="px-4 py-2.5 bg-gray-200 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 hover:bg-gray-300 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold rounded-xl shadow-sm transition-colors flex items-center justify-center">
